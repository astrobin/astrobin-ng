...
export class ValidationLoader {
  ...
  static minlengthValidationMessage(field: FormlyFieldConfig, translate: TranslateService) {
    return translate.instant("Please input at least {{number}} characters", { "number": field.templateOptions.minLength });
  }
  ...
  public init(): void {
    ...
    this.config.addValidatorMessage("minlength", (err, field) => ValidationLoader.minlengthValidationMessage(field, this.translate));
  }
}
