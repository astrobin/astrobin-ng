...
export class ConstellationsService {
  ...
  get constellations(): ConstellationInterface[] {
    ...
    return _constellations[language] ? _constellations[language] : _constellations["en"];
  }
  ...
  private _constellation(data: any): ConstellationInterface {
    ...
    const language =
      this._availableLanguages.indexOf(this.translateService.currentLang) > -1
