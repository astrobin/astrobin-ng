...
@Component({
  ...
  template: `
    ...
    <ng-container *ngIf="!!iotd">
      <div (click)="openImage($event, iotd.image)" class="iotd-container">
        <a
          [href]="'/i/' + iotd.image"
          [ngStyle]="{
            ...
            <div class="text-center text-sm-start">
              <div class="iotd-label">
                ...
                <a
                  ...
                  href="#"
                >
                  <fa-icon class="stats-icon" icon="table-cells"></fa-icon>
                </a>
              </div>
    ...
    <ng-template #iotdStatsOffcanvasTemplate let-offcanvas>
      ...
      <div class="offcanvas-body">
        <div *ngIf="iotdStats" class="stats-container">
...
export class IotdComponent extends BaseComponentDirective implements OnInit {
  ...
  openImage(event: MouseEvent, imageId: ImageInterface["pk"]) {
    ...
    this.imageViewerService.openSlideshow(this.componentId, imageId, FINAL_REVISION_LABEL, [], true).subscribe();
  }
