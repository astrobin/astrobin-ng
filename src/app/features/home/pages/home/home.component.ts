      ...
      <div class="latest-from-the-forums">
        ...
        >
          ...
          <div class="d-flex gap-2 align-items-center">
            <a [href]="classicRoutesService.FORUM_LATEST" class="no-wrap btn btn-link link-primary btn-xs m-0">
              {{ "View all" | translate }}
            </a>

            <a [href]="classicRoutesService.FORUM_HOME + '#new-topic'" class="no-wrap btn btn-primary btn-xs">
              {{ "New topic" | translate }}
            </a>
          </div>
        </div>
