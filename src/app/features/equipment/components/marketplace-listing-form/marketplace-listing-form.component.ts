    ...
    const _doInitFields = (
      ...
      this.fields = [
        ...
        },
        {
          ...
          expressions: {
            hide: () => !!this.initialLineItemCountForm.get("terms")?.value,
            template: config => {
      ...
      .subscribe(({ requestCountry, user }) => {
        ...
        if (!this.model.id && this.initialLineItemCount > 0) {
          ...
          if (
            ...
            const itemContentTypeId = parseInt(this.activatedRoute.snapshot.queryParams.equipmentItemContentTypeId, 10);
        ...
        if (
          ...
          forkJoin(
            ...
            .subscribe(currentUser => {
              const isModerator =
                currentUser && this.userService.isInGroup(currentUser, Constants.MARKETPLACE_MODERATORS_GROUP);
