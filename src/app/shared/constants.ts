...
export class Constants {
  ...
  static readonly ALLOWED_IMAGE_UPLOAD_EXTENSIONS = [".jpg", ".jpeg", ".png", ".gif", ".tif", ".tiff"];
  static readonly ALLOWED_VIDEO_UPLOAD_EXTENSIONS = [".mov", ".mpg", ".mpeg", ".mp4", ".avi", ".wmv", ".webm"];
