...
export class IconsModule {
  constructor(library: FaIconLibrary) {
    ...
    library.addIcons(
      ...
      faMagnifyingGlass, faLanguage, faChartBar, faLocationArrow, faKeyboard
    );
  }
}
