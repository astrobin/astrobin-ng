...
export class IconsModule {
  constructor(library: FaIconLibrary) {
    ...
    library.addIcons(
      ...
      faMagnifyingGlass, faLanguage, faSignInAlt, faUserPlus, faChartBar
    );
  }
}
