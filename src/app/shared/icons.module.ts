...
export class IconsModule {
  constructor(library: FaIconLibrary) {
    ...
    // Add regular icons
    library.addIcons(farStar, farCircle, farBookmark, farComment, farCopyright, farClock, farFile, farFolder, farUser);
    ...
    library.addIcons(
      ...
      faLanguage,
      faChartBar,
      faLocationArrow, faKeyboard, faEraser
    );
  }
}
