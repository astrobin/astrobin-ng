...
// Solid (fas)
import {
  faAdjust, faAngleDown, faAngleUp, faArrowCircleUp, faArrowDown, faArrowLeft, faArrowPointer, faArrowRight, faArrowsAltH, faArrowsAltV, faArrowsLeftRight, faArrowsLeftRightToLine, faArrowsUpDown, faArrowTurnUp, faArrowUp, faAsterisk, faAtom, faBalanceScale, faBan, faBarcode, faBars, faBarsStaggered, faBell, faBookmark, faCalendar, faCalendarAlt, faCalendarXmark, faCamera, faCameraRetro, faChartBar, faChartLine, faChartSimple, faCheck, faCheckCircle, faChevronCircleLeft, faChevronCircleRight, faChevronDown, faChevronLeft, faChevronRight, faChevronUp, faCircle, faCircleCheck, faCircleChevronDown, faCircleChevronUp, faCircleDot, faCircleHalfStroke, faCircleMinus, faCircleNotch, faCirclePlus, faCircleXmark, faCloudUploadAlt, faClock, faCode, faCog, faComment, faCommentAlt, faCommentDollar, faComments, faCompass, faComputerMouse, faCopy, faCopyright, faCrosshairs, faDatabase, faDollar, faDownLeftAndUpRightToCenter, faDroplet, faDumbbell, faEarthAfrica, faEarthAmericas, faEarthAsia, faEarthEurope, faEarthOceania, faEdit, faEllipsis, faEllipsisVertical, faEnvelope, faEquals, faEraser, faEuroSign, faExclamationTriangle, faExpand, faExternalLinkAlt, faEye, faEyeDropper, faEyeSlash, faFile, faFileAlt, faFileCsv, faFileExport, faFileInvoice, faFilter, faFire, faFlag, faFlagUsa, faFolder, faFolderOpen, faFrown, faGavel, faGlobe, faGrip, faHammer, faHandPaper, faHandPointer, faHandshake, faHeart, faHome, faHourglass, faIcicles, faImage, faImages, faInbox, faInfo, faInfoCircle, faKey, faKeyboard, faLanguage, faLaptop, faLayerGroup, faLink, faListAlt, faLocationArrow, faLock, faMagnifyingGlass, faMap, faMapMarkerAlt, faMicrochip, faMoneyBill, faMoon, faMousePointer, faPen, faPencil, faPersonWalkingArrowRight, faPlay, faPlus, faPlusCircle, faQuestion, faQuestionCircle, faRainbow, faReceipt, faRedo, faRepeat, faReply, faRotateLeft, faRuler, faSackDollar, faSave, faSearch, faShare, faShareAlt, faShop, faShoppingCart, faSignOutAlt, faSliders, faSnowflake, faSort, faSortAlphaDown, faSortAlphaUp, faSortAmountDown, faSortDown, faSortNumericDown, faSortNumericUp, faSortUp, faSpinner, faSquare, faStar, faStarHalfStroke, faStore, faSun, faSync, faTableCells, faTableCellsLarge, faTachometerAlt, faTag, faTasks, faTemperatureHigh, faTerminal, faThermometer, faThumbsDown, faThumbsUp, faTimes, faTimesCircle, faTrash, faTrashAlt, faTrophy, faUndo, faUpload, faUser, faUserGroup, faUsers, faVideo
...
export class IconsModule {
  constructor(library: FaIconLibrary) {
    ...
    library.addIcons(
      ...
      faArrowLeft, faArrowPointer, faArrowRight, faArrowUp, faArrowsAltH, faArrowsAltV,
      ...
      faCode, faCog, faComment, faCommentAlt, faCommentDollar, faComments, faCompass,
      ...
      faFileAlt, faFileCsv, faFileExport, faFileInvoice, faFilter, faFlag, faFlagUsa, faFolder,
      ...
      faMagnifyingGlass, faLanguage, faChartBar, faLocationArrow, faKeyboard, faEraser
    );
  }
}
