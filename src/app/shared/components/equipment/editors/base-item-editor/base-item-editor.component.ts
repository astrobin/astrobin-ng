...
export class BaseItemEditorComponent<T extends EquipmentItemBaseInterface>
  ...
  implements OnInit, AfterViewInit
{
  ...
  createBrand() {
    const { ...brand } = this.options.formState.brandCreation.form.value;
  ...
  protected _customNameChangesValidations(_field?: FormlyFieldConfig, _value?: string) {
