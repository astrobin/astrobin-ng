...
export class FormlyFieldCKEditorComponent extends FieldType implements AfterViewInit {
  ...
  private _ckEditorSmileyDescriptions(): any {
    return [
      "angel",
      "angry-1",
      "angry",
  ...
  private _ckEditorSmileyImages(): any {
    return [
      "angel.png",
      "angry-1.png",
      "angry.png",
  ...
  private _ckEditorSpecialChars(): any {
    return [
      "!",
      "&quot;",
      "#",
  ...
  private _ckEditorOptions(): any {
    ...
    return {
      ...
      extraPlugins: this._ckEditorPlugins().join(","),
      toolbar: this._ckEditorToolbar(),
      filebrowserUploadUrl: `${environment.classicBaseUrl}/json-api/common/ckeditor-upload/`,
      mentions: this._ckEditorMentions(),
      smiley_columns: 10,
      smiley_path: "https://cdn.astrobin.com/static/astrobin/emoticons/",
      smiley_descriptions: this._ckEditorSmileyDescriptions(),
      smiley_images: this._ckEditorSmileyImages(),
      specialChars: this._ckEditorSpecialChars(),
      ...
      on: {
        change() {
          this.updateElement();
          self.formControl.setValue(this.getData());
        },
