...
context("Equipment", () => {
  ...
  context("Edit proposal accessory workflow", () => {
    it("should not have the 'Propose edit' button if logged out", () => {
      ...
      cy.get(".card .card-header").contains("Accessory").should("be.visible");
    ...
    it("should submit the form", () => {
      ...
      cy.get("astrobin-accessory-editor").should("not.exist");
    });
    ...
    it("should show the new edit proposal on the page", () => {
      ...
      cy.get("astrobin-item-edit-proposal .change .before").contains("Test accessory").should("be.visible");
      cy.get("astrobin-item-edit-proposal .change .after").contains("Test accessory Pro").should("be.visible");
    });
